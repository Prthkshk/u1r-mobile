...
export default function RetailProfileDetails({ navigation }) {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      const res = await updateProfile(userId, { name, email });
      const nextUser = res.data?.user || null;
      setUserData(nextUser);
        ...
        {loading ? (
          ...
          <>
            <View style={styles.card}>
              ...
              <View style={styles.fieldBox}>
                ...
                <TextInput
                  ...
                  style={[Fonts.bodyBold, styles.input, { color: "#111" }]}
              ...
              <TouchableOpacity
                ...
                disabled={saving}
              >
                <Text style={[Fonts.bodyBold, styles.saveText]}>
            ...
            <TouchableOpacity style={styles.deleteBtn} onPress={() => setShowDeleteModal(true)}>
              <DeleteIcon width={20} height={20} color="#F24B4B" />
...
const styles = StyleSheet.create({
  ...
  input: { fontSize: 14, color: "#000", paddingVertical: 0 },
  saveBtn: {
    marginTop: 14,
